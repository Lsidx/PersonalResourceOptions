...
-- PRO_RegisterSettings is called once from Core.lua after ADDON_LOADED.
...
function PRO_RegisterSettings(db, onChanged, hasAltPowerBar, hasClassFrame, hasCooldownClassFrame)
